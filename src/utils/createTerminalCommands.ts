...
const generateHelpMessage = (commands: Record<string, Command>, command?: string): string => {
    if (command) {
...
export const createTerminalCommands = ({ setHistory }: CommandFactoryOptions): Record<string, Command> => {
...
Usage: /clear`,
        ...
        "/ai": {
            argsHint: ["Type your question....", "Where are you based?", "What's your role?", "What are your skills?", "What's your area of expertise?"],
            description: "Ask an llm questions about me! It's been fed my resume and can answer questions about it.",
