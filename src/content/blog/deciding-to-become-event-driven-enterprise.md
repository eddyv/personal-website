...
date: 2021-08-23
preview: "So, when is an organization ready for event-driven architectures?"
tags: ["event-driven-architecture", "kafka", "architecture"]
draft: false
---
...
![Simple Application Architecture](/blog/event-driven-enterprise/simple-arch.png)
...
![Simple Application Architecture With Multiple Actors](/blog/event-driven-enterprise/multiple-actors.png)
...
![Event Driven Architecture Example](/blog/event-driven-enterprise/event-driven-arch.png)
...
*Originally published on [Stories from the Herd](https://storiesfromtheherd.com/deciding-to-become-an-event-driven-enterprise-93b1dbbc4931)*
