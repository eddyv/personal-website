<template>
  <div>
    <div
      class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-gray-100 dark:bg-indigo-500 dark:border-indigo-800"
    >
      <g-image
      ...
      <div class="p-6">
        ...
        <g-link :to="edge.node.path">
          <h1 class="text-lg font-semibold text-gray-900 mb-3 dark:text-white">
            {{ edge.node.title }}
          </h1></g-link
        >
        <p class="leading-relaxed mb-3 line-clamp-3 dark:text-white">
